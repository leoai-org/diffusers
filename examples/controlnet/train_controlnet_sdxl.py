...
def main(args):
    ...
    with accelerator.main_process_first():
        ...
        train_dataset = train_dataset.map(compute_embeddings_fn, batched=True, batch_size=args.train_batch_size * 600, new_fingerprint=new_fingerprint, load_from_cache_file=not args.recalc_cached_embeddings)
